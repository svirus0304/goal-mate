...
<body>
	...
	<form action="http://localhost/www/findMercenaryWrite" method="post"
		id="frm">
		...
		<div id="findMercenaryDetail2" class="col-lg-3">
			<select name="bpl_area" style="color: white;"
				...
				<option class="options" name="bpl_area" value="" selected="selected">대구의
					구를 선택해주세요</option>
		...
		<div id="findMercenaryDetail2" class="col-lg-3">
			<select name="bpl_age" style="color: white"
				class="input-large form-control" required="required">
				<option class="options" name="bpl_age" value="" selected="selected">나이를
					선택해주세요</option>
				...
				<option class="options" name="bpl_age" value="50대">50대 이상</option>
			</select>
		</div>
