...
<body>
	...
	<form action="http://localhost/www/noticeWrite" method="post" id="frm">

		<label id="noticeDetail3" class="col-lg-2 control-label"> 제목</label>
		<div id="noticeDetail2" class="col-lg-3">
			<input class="form-control text-center" type="text" name="bad_title">
		</div>
		...
		<div align="right" style="margin-top: 2%;">
			<input type="button" class="btn btn-sm btn-noticeAdd" id="savebutton"
				value="등록" /> <input type="button" class="btn btn-sm btn-noticeAdd"
				value="목록보기"
