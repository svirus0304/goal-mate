...
<body>
	<form action="http://localhost/www/findClubModify" method="post"
		id="frm">
		<input type="hidden" value="${dto.bcl_num}" name="bcl_num" /> <label
			id="findClubDetail3" class="col-lg-2 control-label"> 제목</label>
		...
		<div id="findClubDetail2" class="col-lg-3">
			<select name="bcl_area" style="color: white;"
				...
				<option class="options" name="bcl_area" value="">대구의 구를
					선택해주세요</option>
				<c:choose>
					<c:when test="${dto.bcl_area.equals('중구')}">
						<option class="options" name="bcl_area" value="중구"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('동구')}">
						<option class="options" name="bcl_area" value="동구"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('서구')}">
						<option class="options" name="bcl_area" value="서구"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('남구')}">
						<option class="options" name="bcl_area" value="남구"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('달서구')}">
						<option class="options" name="bcl_area" value="달서구"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('달성군')}">
						<option class="options" name="bcl_area" value="달성군"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('북구')}">
						<option class="options" name="bcl_area" value="북구"
				...
				<c:choose>
					<c:when test="${dto.bcl_area.equals('수성구')}">
						<option class="options" name="bcl_area" value="수성구"
		...
		<div id="findClubDetail2" class="col-lg-3">
			<select name="bcl_age" style="color: white"
				class="input-large form-control" required="required">
				<option class="options" name="bcl_age" value="">나이를 선택해주세요</option>
				<c:choose>
					<c:when test="${dto.bcl_age.equals('10대')}">
						<option class="options" name="bcl_age" value="10대"
				...
				<c:choose>
					<c:when test="${dto.bcl_age.equals('20대')}">
						<option class="options" name="bcl_age" value="20대"
				...
				<c:choose>
					<c:when test="${dto.bcl_age.equals('30대')}">
						<option class="options" name="bcl_age" value="30대"
				...
				<c:choose>
					<c:when test="${dto.bcl_age.equals('40대')}">
						<option class="options" name="bcl_age" value="40대"
				...
				<c:choose>
					<c:when test="${dto.bcl_age.equals('50대 이상')}">
						<option class="options" name="bcl_age" value="50대 이상"
							selected="selected">50대 이상</option>
					</c:when>
					<c:otherwise>
						<option class="options" name="bcl_age" value="50대 이상">50대
							이상</option>
					</c:otherwise>
				</c:choose>
			</select>
		...
		<textarea name="bcl_content" id="editor" rows="10" cols="100"
			style="width: 766px; height: 412px;">${dto.bcl_content}</textarea>
