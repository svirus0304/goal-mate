...
<body>
	...
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div id="changePassword">
				<form action="http://localhost/www/changePwd"
					class="form-horizontal" name="checkPass" onsubmit="return check()"
					method="post">
					<fieldset>
						<legend class="mem_checkPass">변경하실 비밀번호를 입력해주세요 </legend>
						<div class="form-group">
							<label for="checkPass" class="col-lg-3 control-label">
								비밀번호</label>
							<div class="col-lg-7">
								<input type="password" name="mem_pw" class="form-control"
									placeholder="변경하실 비밀번호를 입력하세요" required="required">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<input type="password" name="mem_pw2" class="form-control"
									placeholder="위의 비밀번호와 똑같이 입력해주세요" required="required">
							</div>
						</div>
	...
	<script type="text/javascript">
		function check() {
			...
			var pw2 = checkPass.mem_pw2.value;
			if (pw1 != pw2) {
				alert("비밀번호가 일치하지 않습니다.");
				checkPass.mem_pw.value = "";
				checkPass.mem_pw2.value = "";
