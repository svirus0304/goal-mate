    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://localhost/www/findMercenaryMultiplePhotoUpload';
    	/*'file_uploader_html5.php'; 	//upload URL*/
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://localhost/www/findMercenaryPhotoUpload', 
 			/*location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.*/
 	        sCallback :  'resource/editorFmer/photo_uploader/popup/callback.html',
