...
(function ($) {
    ...
    BootstrapFileInput.prototype.init = function () {
        ...
        var input = $('<input type="text" style="width:250px;margin-left:2%;" readonly class="form-control" placeholder="30글자까지 가능 " />');
...
$('#fileUpload3').bootstrapFileInput({// 이거 사용함
    size: 'md',
    btnType: 'btn btn-sm btn-success',
    btnPosition: 'left'
});
