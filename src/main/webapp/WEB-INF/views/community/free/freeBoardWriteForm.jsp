...
<body>
	...
	<form action="http://localhost/www/freeWrite" method="post" id="frm">

		<label id="freeDetail3" class="col-lg-2 control-label"> 제목</label>
		<div id="freeDetail2" class="col-lg-3">
			<input class="form-control text-center" type="text" name="bod_title">
		</div>
		...
		<div align="right" style="margin-top: 2%;">
			<input type="button" class="btn btn-sm btn-freeAdd" id="savebutton"
				value="등록" /> <input type="button" class="btn btn-sm btn-freeAdd"
				value="목록보기"
